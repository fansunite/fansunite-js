...
var League001 = /** @class */ (function (_super) {
    ...
    League001.prototype.getFixtureStart = function (leagueAddress, id) {
        return __awaiter(this, void 0, void 0, function () {
            var instance, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        instance = this._getLeagueContractInstance(leagueAddress);
                        return [4 /*yield*/, instance.methods.getFixtureStart(id).call()];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, Number(result)];
                }
            });
        });
    };
    ...
    League001.prototype.getParticipants = function (leagueAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var participants, _a, _b, _c, _d, participantPromises;
            var _this = this;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _c = [null];
                        _d = {};
                        return [4 /*yield*/, this.getParticipantCount(leagueAddress)];
                    case 1:
                        participants = _b.apply(_a, _c.concat([(_d.length = _e.sent(), _d)])).map(Number.call, Number);
                        participantPromises = participants.map(function (n) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            return [2 /*return*/, this.getParticipant(leagueAddress, new BN(n + 1))];
                        }); }); });
                        return [4 /*yield*/, Promise.all(participantPromises)];
                    case 2:
    ...
    League001.prototype.getParticipantCount = function (leagueAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var instance, count;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        instance = this._getLeagueContractInstance(leagueAddress);
                        return [4 /*yield*/, instance.methods.getParticipantCount().call()];
                    case 1:
                        count = _a.sent();
