...
var ResolverRegistry = /** @class */ (function (_super) {
    ...
    ResolverRegistry.prototype.isResolverUsed = function (league, resolver) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                instance = this._getResolverRegistryInstance();
                return [2 /*return*/, instance.methods.isResolverUsed(league, resolver).call()];
            });
        });
    };
    ResolverRegistry.prototype.getContractAddress = function () {
        return artifacts_1.artifacts.ResolverRegistry.networks[this.networkId].address;
    };
    ResolverRegistry.prototype._getResolverRegistryInstance = function () {
        ...
        this.resolverRegistryInstance = new this.web3.eth.Contract(artifacts_1.artifacts.ResolverRegistry.abi, artifacts_1.artifacts.ResolverRegistry.networks[this.networkId].address);
        return this.resolverRegistryInstance;
    };
