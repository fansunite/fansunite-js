...
var Vault = /** @class */ (function (_super) {
    ...
    Vault.prototype.deposit = function (token, amount, from) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                instance = this._getVaultInstance();
                return [2 /*return*/, instance.methods.deposit(token, amount).send({ from: from, value: amount })];
            });
        });
    };
    ...
    Vault.prototype.balanceOf = function (token, user) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                instance = this._getVaultInstance();
                return [2 /*return*/, instance.methods.balanceOf(token, user).call()];
            });
        });
    };
    ...
    Vault.prototype._getVaultInstance = function () {
        return new this.web3.eth.Contract(artifacts_1.artifacts.Vault.abi, artifacts_1.artifacts.Vault.networks[this.networkId].address);
    };
    return Vault;
