...
describe('FansUnite library', function () {
    ...
    describe('League001', function () {
        ...
        it('should return `false` if resolver is registered', function () { return __awaiter(_this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        it('should return `false` if fixture is scheduled', function () { return __awaiter(_this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
